...
class DIEM3CMAU : public DIEM3C, public MAU{
    ...
    public:
        ...
        DIEM3CMAU& operator=(const DIEM3CMAU&);
        static int GetDem();
        void Nhap();
        void Xuat() const;
...
DIEM3CMAU::DIEM3CMAU(): DIEM3C(), MAU(){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x): DIEM3C(x), MAU(){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x, double y): DIEM3C(x, y), MAU(){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x, double y, double z): DIEM3C(x, y, z), MAU(){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x, double y, double z, int r): DIEM3C(x, y, z), MAU(r){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x, double y, double z, int r, int g): DIEM3C(x, y, z), MAU(r, g){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(double x, double y, double z, int r, int g, int b): DIEM3C(x, y, z), MAU(r, g, b){
    ++dem;
}
DIEM3CMAU::DIEM3CMAU(const DIEM3CMAU& d): DIEM3C(d), MAU(d){
    ++dem;
}
DIEM3CMAU& DIEM3CMAU::operator=(const DIEM3CMAU& d){
    DIEM3C::operator=(d);
    MAU::operator=(d);
    return *this;
}
...
istream& operator>>(istream& in, DIEM3CMAU& d){
    d.Nhap();
    return in;
}
ostream& operator<<(ostream& out, const DIEM3CMAU& d){
    d.Xuat();
    return out;
}
bool DIEM3CMAU::KiemTraTrung(const DIEM3CMAU& d) const{
    return DIEM3C::KiemTraTrung(d)&&MAU::KiemTraTrungMau(d);
}
int main(){
    ...
    d1_copy.Quay(alpha);
    cout<<"d) Sau khi quay "<<alpha<<" do quanh truc Oz: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOx();
    cout<<"e) Doi xung qua truc Ox: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOy();
    cout<<"f) Doi xung qua truc Oy: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOz();
    cout<<"g) Doi xung qua truc Oz: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOxy();
    cout<<"h) Doi xung qua mat phang Oxy: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOxz();
    cout<<"i) Doi xung qua mat phang Oxz: "<<d1_copy<<endl;
    d1_copy=d1; d1_copy.DoiXungOyz();
    cout<<"j) Doi xung qua mat phang Oyz: "<<d1_copy<<endl;
    ...
    cout<<"- So luong diem DIEM3CMAU: "<<DIEM3CMAU::GetDem()<<endl;
